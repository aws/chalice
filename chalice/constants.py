...
DEFAULT_LAMBDA_ROLE_NAME_CONVENSION = "{app_name}-{chalice_stage}-{func_name}"
DEFAULT_LAMBDA_DEFAULT_ROLE_NAME_CONVENSION = "{app_name}-{chalice_stage}"
DEFAULT_EVENT_RULE_NAME_CONVENSION = "{app_name}-{chalice_stage}-{resource_name}"
